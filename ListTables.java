...
public class ListTables {
    public static void main(String[] args) throws IOException {
        ...
        Document doc = Jsoup.connect("https://en.wikipedia.org/wiki/List_of_countries_by_population_(United_Nations)").userAgent("Chrome").get();  //.userAgent is additionally prefered to simulate chrome or mozilla
        ...
        for (Element table : tables) { print("Table name : <%s>  ", table.className());
